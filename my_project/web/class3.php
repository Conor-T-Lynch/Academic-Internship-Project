...
$questions = json_decode($jsonData, true)['class3'];
...
<head>
    ...
    <title>3rd Class Mathematical Questions</title>
</head>
<body>
<header>
    <!-- Logo -->
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <h2>3rd Class Mathematical Questions</h2>
            <div class="score">
            ...
            <?php else: ?>
                ...
                <form method="post" action="class3.php">
