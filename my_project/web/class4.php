...
$questions = json_decode($jsonData, true)['class4'];
...
<head>
    ...
    <title>4th Class Mathematical Questions</title>
</head>
<body>
<header>
    <!-- Logo -->
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <h2>4th Class Mathematical Questions</h2>
            <div class="score">
            ...
            <?php else: ?>
                ...
                <form method="post" action="class4.php">
